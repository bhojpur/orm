...
func (ListenRequestLogs) Descriptor() protoreflect.EnumDescriptor {
	return file_orm_proto_enumTypes[1].Descriptor()
}

func (ListenRequestLogs) Type() protoreflect.EnumType {
	return &file_orm_proto_enumTypes[1]
}
...
func (EngineTrigger) Descriptor() protoreflect.EnumDescriptor {
	return file_orm_proto_enumTypes[2].Descriptor()
}

func (EngineTrigger) Type() protoreflect.EnumType {
	return &file_orm_proto_enumTypes[2]
}
...
func (EnginePhase) Descriptor() protoreflect.EnumDescriptor {
	return file_orm_proto_enumTypes[3].Descriptor()
}

func (EnginePhase) Type() protoreflect.EnumType {
	return &file_orm_proto_enumTypes[3]
}
...
func (LogSliceType) Descriptor() protoreflect.EnumDescriptor {
	return file_orm_proto_enumTypes[4].Descriptor()
}

func (LogSliceType) Type() protoreflect.EnumType {
	return &file_orm_proto_enumTypes[4]
}
...
func (*EngineMetadata) Descriptor() ([]byte, []int) {
	return file_orm_proto_rawDescGZIP(), []int{16}
}
...
func (*Repository) Descriptor() ([]byte, []int) {
	return file_orm_proto_rawDescGZIP(), []int{17}
}
...
func (*Annotation) Descriptor() ([]byte, []int) {
	return file_orm_proto_rawDescGZIP(), []int{18}
}
...
func (*EngineConditions) Descriptor() ([]byte, []int) {
	return file_orm_proto_rawDescGZIP(), []int{19}
}
...
func (*EngineResult) Descriptor() ([]byte, []int) {
	return file_orm_proto_rawDescGZIP(), []int{20}
}
...
func (*LogSliceEvent) Descriptor() ([]byte, []int) {
	return file_orm_proto_rawDescGZIP(), []int{21}
}
...
func (*StopEngineRequest) Descriptor() ([]byte, []int) {
	return file_orm_proto_rawDescGZIP(), []int{22}
}
...
func (*StopEngineResponse) Descriptor() ([]byte, []int) {
	return file_orm_proto_rawDescGZIP(), []int{23}
}

var File_orm_proto protoreflect.FileDescriptor

var file_orm_proto_rawDesc = []byte{
	0x0a, 0x09, 0x6f, 0x72, 0x6d, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x02, 0x76, 0x31, 0x1a,
	...
	0x55, 0x4c, 0x54, 0x10, 0x06, 0x32, 0xa6, 0x04, 0x0a, 0x0a, 0x4f, 0x72, 0x6d, 0x53, 0x65, 0x72,
	...
	0x6a, 0x70, 0x75, 0x72, 0x2f, 0x6f, 0x72, 0x6d, 0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x61, 0x70, 0x69,
...
var file_orm_proto_enumTypes = make([]protoimpl.EnumInfo, 5)
var file_orm_proto_msgTypes = make([]protoimpl.MessageInfo, 24)
var file_orm_proto_goTypes = []interface{}{
...
var file_orm_proto_depIdxs = []int32{
	...
	5,  // 27: v1.OrmService.StartLocalEngine:input_type -> v1.StartLocalEngineRequest
	8,  // 28: v1.OrmService.StartFromPreviousEngine:input_type -> v1.StartFromPreviousEngineRequest
	7,  // 29: v1.OrmService.StartEngine:input_type -> v1.StartEngineRequest
	9,  // 30: v1.OrmService.ListEngines:input_type -> v1.ListEnginesRequest
	14, // 31: v1.OrmService.Subscribe:input_type -> v1.SubscribeRequest
	16, // 32: v1.OrmService.GetEngine:input_type -> v1.GetEngineRequest
	18, // 33: v1.OrmService.Listen:input_type -> v1.ListenRequest
	27, // 34: v1.OrmService.StopEngine:input_type -> v1.StopEngineRequest
	6,  // 35: v1.OrmService.StartLocalEngine:output_type -> v1.StartEngineResponse
	6,  // 36: v1.OrmService.StartFromPreviousEngine:output_type -> v1.StartEngineResponse
	6,  // 37: v1.OrmService.StartEngine:output_type -> v1.StartEngineResponse
	13, // 38: v1.OrmService.ListEngines:output_type -> v1.ListEnginesResponse
	15, // 39: v1.OrmService.Subscribe:output_type -> v1.SubscribeResponse
	17, // 40: v1.OrmService.GetEngine:output_type -> v1.GetEngineResponse
	19, // 41: v1.OrmService.Listen:output_type -> v1.ListenResponse
	28, // 42: v1.OrmService.StopEngine:output_type -> v1.StopEngineResponse
...
func file_orm_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_orm_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_orm_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_orm_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_orm_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_orm_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_orm_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_orm_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_orm_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_orm_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_orm_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_orm_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
		...
		file_orm_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
		...
		file_orm_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
		...
		file_orm_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
		...
		file_orm_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
		...
		file_orm_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
		...
		file_orm_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
		...
		file_orm_proto_msgTypes[17].Exporter = func(v interface{}, i int) interface{} {
		...
		file_orm_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
		...
		file_orm_proto_msgTypes[19].Exporter = func(v interface{}, i int) interface{} {
		...
		file_orm_proto_msgTypes[20].Exporter = func(v interface{}, i int) interface{} {
		...
		file_orm_proto_msgTypes[21].Exporter = func(v interface{}, i int) interface{} {
		...
		file_orm_proto_msgTypes[22].Exporter = func(v interface{}, i int) interface{} {
		...
		file_orm_proto_msgTypes[23].Exporter = func(v interface{}, i int) interface{} {
	...
	file_orm_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	file_orm_proto_msgTypes[14].OneofWrappers = []interface{}{
